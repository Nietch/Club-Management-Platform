...
public class Bbs {
	...
	public String getBoard_cd() {
		/*
		 * if (board_cd.equals("007001")) board_cd = "공지사항"; else
		 * if(board_cd.equals("007002")) board_cd = "자유게시판"; else
		 * if(board_cd.equals("007003")) board_cd = "사진"; else
		 * if(board_cd.equals("007004")) board_cd = "일정";
		 */
		return board_cd;
	}
